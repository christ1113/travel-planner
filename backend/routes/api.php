...
Route::middleware('auth:sanctum')->delete('/plan/{plan}', [PlanController::class, 'destroy']);//刪除計畫
...
Route::middleware('auth:sanctum')->delete('/journeys/{journey}', [JourneyController::class, 'destroy']);//刪除單一行程

//儲存按鈕刪除不存在的行程
Route::middleware('auth:sanctum')->put('/plans/{plan}/journeys/keep', [PlanController::class, 'keepJourneys']);